...
{
    [AssetModifier]
    public class ModleImportSetting : AssetSetting,IAssetModifier
    {

        void IAssetModifier.Hanlde(List<AssetFile> input, out List<AssetFile> output)
        {
            output = input;
            Apply<ModelImporter>(input,output);
        }
        ...
        {
            ModelImporter reference = templeteImproter as ModelImporter;
            ModelImporter target = importer as ModelImporter;
